# Genshin Impact Assistant Document

<div align="center">

Genshin Impact Assistant（GIA）是基于图像识别和模拟按键的多功能原神自动辅助操作工具，包括自动战斗、自动刷秘境、自动刷大世界材料等功能。
...
本仓库为GIA的文档仓库，主仓库[在这里](https://github.com/infstellar/genshin_impact_assistant)。

文档地址：[https://genshinimpactassistant.github.io/GIA-Document/](https://genshinimpactassistant.github.io/GIA-Document/)

本文档基于[docsify](https://docsify.js.org/#/)部署。

## 参与文档编写

非常欢迎参与文档的编写，详见[此说明](https://genshinimpactassistant.github.io/GIA-Document/#/zh_CN/dev/write_doc)。

## 参与开发

非常欢迎提交PR。如果你想参与GIA的开发，可以从[GIA Dev Document](https://genshinimpactassistant.github.io/GIA-Document/#/zh_CN/dev/)开始。
